...
router.post('/', async function(req, res, next) {
    ...
    var gAmount = req.body["goalAmount"];
    ...
    //     return;
    // }
    newGoal = goalModel.create({userID: 1, goalID: gID, goalAmount: gAmount, goalProgress: gProgress, goalName: gName,goalSlider: gSlider});
